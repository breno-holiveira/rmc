...
def load_data(path="despesas_sp.xlsx"):
    ...
    # Descarta linhas sem valor numérico em 'Despesa' ou sem ano válido
...
def show():
    ...
    st.download_button(
        "📥 Baixar dados C&T (CSV)",data=csv,file_name="despesas_ct_2016_2021.csv",mime="text/csv")
