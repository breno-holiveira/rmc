...
<head>
  ...
  <style>
    ...
    #sidebar {{
      ...
      border-right: 1px solid rgba(71,88,110,0.2);
      padding: 16px;
      overflow-y: auto;
    ...
    #sidebar::-webkit-scrollbar-thumb {{
      background-color: rgba(120,140,160,0.3);
      border-radius: 8px;
    }}
    #sidebar:hover::-webkit-scrollbar-thumb {{
      background-color: rgba(120,140,160,0.5);
    }}
    #sidebar h2 {{
      margin: 0 0 12px;
      color: #35455e;
    ...
    .area {{
      ...
      stroke: rgba(71,88,110,0.7);
      stroke-width: 1;
      cursor: pointer;
      transition: all 0.2s ease;
    }}
    .area:hover {{
      fill: rgba(140,160,185,0.7);
      stroke-width: 1.2;
    }}
    .area.selected {{
      fill: rgba(71,88,110,0.8);
      stroke: rgba(54,75,102,1);
      stroke-width: 1.5;
    }}
    #tooltip {{
      position: fixed;
