...
<style>
  ...
  #sidebar {{position:fixed;top:0;left:0;width:240px;height:100vh;background:rgba(255,255,255,0.80);backdrop-filter:blur(12px);border-right:1px solid rgba(71,88,110,0.2);padding:16px;overflow-y:auto;scroll-behavior:smooth;z-index:10;box-shadow:2px 0 8px rgba(0,0,0,0.06);transition:0.3s;}}
